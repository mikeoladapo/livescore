...
function renderLiveMatches(matches) {
  ...
  orderedMatches.forEach((match, index) => {
    ...
    matchElement.innerHTML = `
        <img src="/static/m/images/trophy.png" class="absolute top-0 bottom-0 left-0 -z-10" alt="" />
        <a href="/m/league-info/${match.league.id}/" class="text-base font-semibold">${match.league.name}</a>
        ...
        <div class="flex justify-between items-center pt-3">
            <a href="/m/match-detail/${match.fixture.id}/" class="flex justify-center items-center flex-col">
...
function fetchRecentUpdates(date = null) {
  ...
  const url = new URL("/m/api/recent-updates/", window.location.origin);
  if (selectedDate) {
...
function renderRecentUpdates(matches) {
    ...
    matchElement.innerHTML = `
        <div class="flex justify-between items-center bg-n900 rounded-t-xl text-white p-5">
            <div class="flex justify-start items-center gap-4">
                ...
                <div>
                    <a href="/m/league-info/${match.leagueId}" class="text-lg font-semibold relative">
                        ${match.leagueName}
        ...
        <div class="p-4 flex flex-col gap-4">
            <a href="/m/match-detail/${
              match.id
            }/" class="p-5 rounded-xl bg-white flex justify-between items-center gap-6 dark:bg-black">
                <div class="w-full">
  ...
  // Insert ad at the end
  // const endAdElement = document.createElement("div");
  // endAdElement.classList.add("flex", "justify-center", "items-center", "my-4");
  // endAdElement.innerHTML = `
  //     <a href="https://www.betway.com.ng/?btag=P105314-PR25154-CM79705-TS2010123" target="_blank" rel="nofollow">
  //         <img src="https://secure.betwaypartnersafrica.com/imagehandler/525c9174-9834-4a89-8083-7d203fbc5281/" border="0" alt="Ad 2"/>
  //     </a>
  // `;
  // container.appendChild(endAdElement);
}



function fetchLiveMatches2() {
  const url = new URL("/m/api/live-matches-all/", window.location.origin);
...
function renderLiveMatches2(matches) {
  ...
  matches.forEach((match) => {
    ...
    matchElement.innerHTML = `
                ...
                <a href="/m/league-info/${match.leagueId}" class="text-base font-semibold">${match.leagueName}</a>
                <p class="text-xs pt-1 pb-6">${match.group}</p>
                <div class="flex justify-center items-center w-full border-t border-dashed border-n500">
                    <p class="bg-n900 -mt-3 w-fit px-2 dark:bg-blackN30">VS</p>
                </div>
                <div class="flex justify-between items-center pt-3">
                    <a href="/m/match-detail/${match.id}/" class="flex justify-center items-center flex-col">
...
function renderFinishedMatches(matches) {
  ...
  matches.forEach((match) => {
    ...
    matchElement.innerHTML = `
        <div class="flex justify-between items-center bg-n900 rounded-t-xl text-white p-5 dark:bg-blackN30">
            <div class="flex justify-start items-center gap-4">
                ...
                <div>
                    ...
                    <a href="/m/league-info/${match.leagueId}"> ${match.leagueName}
                        <i class="ph-fill ph-star absolute -top-1 -right-6 text-o300"></i>
                    </p>
                    <p class="pt-1">${match.group}</p>
                </div>
        ...
        <div class="p-4 flex flex-col gap-4">
            <a href="#" class="p-5 rounded-xl bg-white flex justify-between items-center gap-6 dark:bg-black">
                <div class="w-full">
                    <div class="flex justify-between items-center pb-4">
                        <div class="flex justify-start items-center gap-3">
